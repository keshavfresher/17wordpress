		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
				...
				<?php if( get_post_meta($post->ID,'_verified',true ) == 'on') {
					...
					<div id="un_verified_listing_widget" class="listing-widget widget listeo_core widget_listing_owner boxed-widget my_widget1">
						<div>
								<h4><b> Send Message To This Business : </b></h4>
								<p> Unfortunately, this business is not on the Hypley network. </p>
								<p> If you’d like, you can still contact this business. </p>
								<p> Please click message button below. </p>
											...
											<div id="small-dialog" class="zoom-anim-dialog mfp-hide">
												...
												<div id="unverify_listing_msg_form" class="message-reply margin-top-0">
													<form>
														...
														<textarea 
														required
														cols="40" id="contact-message" name="message" rows="3" placeholder="<?php esc_attr_e('Your message','listeo_core'); ?>"></textarea>
