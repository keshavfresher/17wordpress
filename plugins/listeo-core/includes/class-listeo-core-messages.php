...
//     }
	...
	*/
    ...
    public function send_unverify_listing_msg(){
        ...
        $mail_content = '<div><p><a href="'.$listing_url.'"> '.$listing_url.' </a> a message has been submitted via unverified form </p> <p> '.$message.' </p> </div>';

        //if(wp_mail('keshav.fresher@gmail.com','Unverified Listing Contact',$mail_content) )
        if(wp_mail($admin_mail,'Unverified Listing Contact',$mail_content) )
        {
            $result['success'] = "1";
        }
        else {
